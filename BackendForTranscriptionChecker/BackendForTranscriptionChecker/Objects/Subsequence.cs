...
namespace BackendForTranscriptionChecker.Objects
{
    class Subsequence
    {
        private readonly string _sequenceString;
        private readonly int _totalMatches = 0; 
        private readonly List<int> _listOfPos; //index is match number, value is position
